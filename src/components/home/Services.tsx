  ...
  return (
    <section className="section alt" id="services" aria-labelledby="svc-h">
      <div className="container">
        ...
        <div className="reveal mb-16 lg:mb-24 flex flex-col items-center">
          <h2 className="heading mb-6 text-center">
            Our digital marketing <span className="serif">services.</span>
          </h2>
          <p className="body-text text-center mx-auto max-w-[680px]" style={{ color: "var(--c-body)" }}>
        ...
        <div className="reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <a
            href="/contact"
            className="flex flex-col p-8 lg:p-10 bg-[var(--c-bg)] border border-[var(--c-line)] rounded-3xl  hover:border-[var(--c-green)]  hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] group"
          >
            <div className="mb-5 w-14 h-14 flex items-center justify-center rounded-2xl bg-[#21759B]/10 ">
              <svg
                className="w-7 h-7"
                aria-hidden={true}
                focusable="false"
            ...
            <h3 className="text-[22px] font-semibold mb-4 leading-tight" style={{ color: "var(--c-ink)" }}>
              Hire WordPress Developer
            </h3>
            <p className="text-[16px] leading-relaxed mb-8 flex-grow" style={{ color: "var(--c-secondary)" }}>
            ...
            >
              Explore <span aria-hidden={true} className="transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1">↗</span>
            </span>
          </a>
          ...
          >
            ...
            <p className="text-[16px] leading-relaxed mb-8 flex-grow" style={{ color: "var(--c-secondary)" }}>
              Shopify development services for custom storefronts and
              conversion focused ecommerce stores that actually sell.
            </p>
            <span
              className="text-[13px] font-bold uppercase tracking-widest flex items-center gap-2 mt-auto transition-colors duration-300"
              style={{ color: "var(--c-green-link)" }}
          ...
          >
            ...
            <p className="text-[16px] leading-relaxed mb-8 flex-grow" style={{ color: "var(--c-secondary)" }}>
              Search engine optimization that earns rankings, from technical
              SEO and on page SEO to ecommerce SEO.
            </p>
            <span
              className="text-[13px] font-bold uppercase tracking-widest flex items-center gap-2 mt-auto transition-colors duration-300"
              style={{ color: "var(--c-green-link)" }}
